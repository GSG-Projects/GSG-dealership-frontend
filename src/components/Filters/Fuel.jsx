...
export default function Fuel() {
    ...
    return (
        <div className="w-full relative overflow-visible">
            ...
            <ul className={`w-2/3 absolute left-0 bg-neutral-800 border border-white transition-all ease-in-out duration-300 overflow-visible z-50 ${dropDown ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'}`}>

export default function ListDropDown({ children, fuel, transmission, isSelected, onSingleSelect, onMultipleSelect }) {
    return (
        <li 
            onClick={fuel || transmission ? onMultipleSelect : onSingleSelect} 
